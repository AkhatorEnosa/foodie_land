  ...
  return (
    <div className="recipe2 max-w-[290px] flex flex-col cursor-pointer group">
        <div className='relative flex w-[290px] h-[200px] mb-4 justify-center items-center overflow-clip rounded-[20px]'>
            ...
            <span className={like === false ? 'absolute p-3 bg-white rounded-full text-[#DBE2E5] hover:text-[#FF6363] z-50 text-2xl right-4 -top-16 transition-all duration-200 group-hover:top-4 ' : 'absolute p-3 bg-white rounded-full text-[#FF6363] z-50 text-2xl right-4 top-4'} onClick={()=>handleLike()}><FaHeart /></span>
        </div>
