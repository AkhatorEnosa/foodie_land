...
const Recipe = ({id, imgSrc, title, detailsTitle1, detailsTitle2} : RecipeProps) => {
  ...
  return (
    <div className="recipe max-w-[400px] px-4 pt-4 pb-8 flex flex-col gap-6 group justify-center items-center md:items-start">
            <div className='relative flex w-full h-[250px] justify-center items-center overflow-clip rounded-[30px]'>
                <Image src={imgSrc} width={368} height={364} className='z-30 lg:w-[300px] xl:w-[368px]' alt='recipe '/>
            ...
            <Link href={{
                ...
                <div className='w-full text-2xl -tracking-[-4%] text-center md:text-left group-hover:underline cursor-pointer'>
                    <p className="recipe-title z-40">{title}</p>
                </div>
