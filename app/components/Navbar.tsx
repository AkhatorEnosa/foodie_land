  ...
  return (
    <section role='navbar' className='w-full flex justify-between items-center mb-20'>
        ...
        <div className='socials flex gap-10'>
            <p className='cursor-pointer hover:text-black/50'><FaFacebookF /></p>
            <p className='cursor-pointer hover:text-black/50'><FaTwitter /></p>
            <p className='cursor-pointer hover:text-black/50'><FaInstagram /></p>
        </div>
    </section>
  )
}
