...
const Recipe2 = ({imgSrc, title, detailsTitle1, detailsTitle2} : RecipeProps) => {
  return (
    <div className="recipe2 max-w-[290px] flex flex-col">
        <div className='relative flex w-[290px] h-[200px] mb-4 justify-center items-center overflow-clip rounded-[20px]'>
            ...
            <span className='absolute p-3 bg-white rounded-full text-[#DBE2E5] hover:text-[#FF6363] z-50 text-2xl right-4 top-4'><FaHeart /></span>
        </div>
