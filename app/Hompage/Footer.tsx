...
const Footer = () => {
  return (
    <footer className='w-full flex flex-col px-20 gap-24'>
        <div className='top-footer flex justify-between items-center'>
            <div className="top-left flex flex-col gap-4">
                ...
                <p className='leading-7 w-fit'>Lorem ipsum dolor sit amet, consectetuipisicing elit, </p>
            </div>
        ...
        <div className="relative w-full flex items-center justify-center text-center bottom-footer py-12 border-t-[1px] border-black/10">
            <p className='text-lg leading-[22.68px]'>© 2020 Flowbase. Powered by <span className='text-orange-500'>Webflow</span></p>
            <div className='socials absolute right-20 flex gap-10'>
